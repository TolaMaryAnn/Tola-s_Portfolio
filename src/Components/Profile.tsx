// function Profile() {
//   return (
//     <section className="w-full min-h-screen flex justify-center items-center px-4 sm:px-6">
//       <div
//         className="
//             relative w-full max-w-4xl rounded-3xl border shadow-xl
//             py-24 px-6 sm:px-10 text-center
//             mt-28 sm:mt-32
//           "
//         style={{
//           borderColor: "#7B4B35", // primaryBrown
//           backgroundColor: "rgba(0, 0, 0, 0.25)", // subtle dark glass
//         }}
//       >
//         {/* Floating Profile Image */}
//         <div
//           className="
//               absolute left-1/2 -top-16 sm:-top-20 -translate-x-1/2
//               w-32 h-32 sm:w-40 sm:h-40 rounded-full overflow-hidden shadow-2xl
//             "
//           style={{
//             border: "6px solid #C79A7D", // warmCaramel border
...
//               mt-20 sm:mt-10 mb-4 sm:mb-6
//             "
//           style={{ color: "#D9A066" }} // goldenBrown
//         >
...
//               text-white leading-relaxed mb-4 sm:mb-6
//             "
//         >
//           I love taking ideas apart and rebuilding them into something cleaner,
//           smarter, and more beautiful. I enjoy creating smooth, thoughtful user
//           experiences and bringing digital products to life.
//         </p>
...
//             "
//         >
//           "Through personal projects and gigs 🙂, I’ve experimented with a variety
//           of creative and technical challenges, learning how to craft
//           experiences that are intuitive, meaningful, and user-focused. I thrive
//           on building things from scratch, refining them, and seeing how small
